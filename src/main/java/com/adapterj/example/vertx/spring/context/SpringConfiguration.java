package com.adapterj.example.vertx.spring.context;
 ...
 */
@Configuration
@EnableJpaRepositories(basePackages = {"com.adapterj.example.vertx.spring.repository"})
@PropertySource(value = { "classpath:example.properties" })
@ComponentScan("com.adapterj.example.vertx.spring.service")
public class SpringConfiguration {
  ...
  public LocalContainerEntityManagerFactoryBean entityManagerFactory(final DataSource dataSource) {
    ...
    factory.setPackagesToScan("com.adapterj.example.vertx.spring.entity");
  ...
  public DatabasePopulator databasePopulator() {
    ...
    populator.addScript(new ClassPathResource("example-h2.sql"));
    return populator;
  }
}
