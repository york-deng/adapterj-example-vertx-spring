...
public class WelcomePage extends AbstractPage {
    ...
    private static final long serialVersionUID = 7698299698160534964L;
    ...
    public WelcomePage(String title, int waitRedirect, String redirect) {
        this(title);
        this.waitRedirect = waitRedirect;
        this.redirect = redirect;
    }

    public WelcomePage(String title, boolean logged) {
        this(title);
        this.logged = logged;
    }
